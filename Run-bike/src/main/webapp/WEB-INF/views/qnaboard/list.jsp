		    	...
		    	$.ajax({
					...
					success : function(data){
		                ...
		                for(var i=0; i<data.length;i++){
		                    ...
		                    //html += '<td>' + data[i].message_regdate +' </td>';
...
//		                    html += '<button id="listhidebtn">리스트접기</button>';
							...
							html += '<button id="replywritebtn" onclick="writeCmt('+data[i].q_num+')">답글작성</button>';
							}
		                    html += '</td>';
...
// 							html += '<td><button id="replywritebtn" onclick="writeCmt('+data[i].q_num+')">답변작성</button></td>';
