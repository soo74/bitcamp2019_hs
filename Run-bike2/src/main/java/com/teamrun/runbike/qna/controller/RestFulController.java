...
public class RestFulController {
	 ...
	 * @CrossOrigin
	 * 
	 * @PostMapping("/reply") public ResponseEntity<String>
	 * boardreply(RequestMemberWrite regRequest, HttpServletRequest request) {
	 * 
	 * System.out.println(regRequest);
	 * 
	 * int cnt = writeboardService.replywrite(request, regRequest);
	 * 
	...
	/* 답글 등록시 필요한 원글의 글번호찾기 */
	/*
	 * @CrossOrigin
	 * 
	 * @GetMapping("/reply/{q_num}") public ResponseEntity<Message>
	 * getreplyInfo(@PathVariable("q_num") int q_num) {
	 * 
	 * Message info = boardeditService.getEditFormData(q_num);
	 * 
	 * return new ResponseEntity<Message>(info, HttpStatus.OK);
	 ...
	 * @CrossOrigin
	 * 
	 * @PostMapping("/reply/{q_num}") public ResponseEntity<String>
	 * boardreply(RequestReply regRequest,HttpServletRequest request) {
	 * 
	 * System.out.println(regRequest);
	 * 
	 * int cnt = writeboardService.replywrite(request, regRequest);
	 ...
	 * @CrossOrigin
	 * 
	 * @GetMapping("/reply/list") public ResponseEntity<List<Message>>
	 * replyboardlist(){
	 * 
	 * List<Message> list = boardlistService.replyList();
	 * 
	 * ResponseEntity<List<Message>> entity = new
	 * ResponseEntity<List<Message>>(list,HttpStatus.OK);
	 * 
	 * return entity; }
	 * 
	 */
